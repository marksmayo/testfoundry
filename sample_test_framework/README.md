# Example Website Test Automation Framework

This project contains automated tests for **Example Website** using Python, pytest, and Playwright.

## Test Coverage

This framework includes the following test types:
- **Basic Tests**: Homepage loading, navigation, JavaScript error detection\n- **Accessibility Tests**: WCAG compliance, keyboard navigation, color contrast, alt text\n- **Performance Tests**: Lighthouse scores, Core Web Vitals, page load metrics\n- **Link Validation**: Broken links, external link security, image sources\n- **SEO Tests**: Meta tags, heading structure, Open Graph, structured data
...
This test automation framework is for testing **Example Website** and is subject to your organization's testing and quality assurance policies.
