# Example Website (Refactored) Test Automation Framework

This project contains automated tests for **Example Website (Refactored)** using Python, pytest, and Playwright.
